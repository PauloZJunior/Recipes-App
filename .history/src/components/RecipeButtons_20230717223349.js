    ...
    <>
      <div className="socialIcons">
        ...
        <button
          ...
          src={ favorited ? favortiteIcon : whiteHeartIcon }
          className="favoriteButton"
        >
          {favorited ? (
            <img src={ blackHeartIcon } alt="Favorite" className="favoriteFill" />
          ) : (
            <img src={ whiteHeartIcon } alt="Favorite" className="favoriteNotFill" />
          )}
        </button>
      </div>
