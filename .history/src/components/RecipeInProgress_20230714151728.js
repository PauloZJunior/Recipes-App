...
import favoriteIconFilled from '../images/favoriteIconFilled.svg';
...
function RecipeInProgress() {
  ...
  const handleIngredientCheck = (ingredientIndex) => {
    ...
    if (isChecked) {
      setCheckedIngredients(checkedIngredients.filter((index) => index !== ingredientIndex));
    } else {
  ...
  return (
    <div>
      <img src={ recipe.strMealThumb || recipe.strDrinkThumb } alt="recipe" data-testid="recipe-photo" />
          ...
          if (key.includes('Ingredient') && recipe[key]) {
            ...
            return (
              <li key={ ingredientIndex }>
                <label data-testid={ `${ingredientIndex}-ingredient-step` } style={ ingredientStyle }>
                  <input
                    type="checkbox"
                    checked={ isChecked }
      ...
      <button type="button" data-testid="favorite-btn" onClick={ handleFavoriteClick }>
        {favorited ? (
