...
function RecipeInProgress() {
  ...
  return (
    <div className="InProgressMainContainer">
      ...
      {recipeType === 'meals' ? (
        <p data-testid="recipe-category" className="inProgressCategory">{recipe.strCategory}</p>
      ) : (
      ...
      <h3 className="intructionsTitle">Instructions</h3>
      {recipe.strInstructions && (
        <div data-testid="instructions" className="instructionsContainer">
