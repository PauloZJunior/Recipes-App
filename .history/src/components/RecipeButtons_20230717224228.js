...
import favortiteIcon from '../images/favoriteIcon.svg';
    ...
    <>
      <div className="socialIcons">
        ...
        <button
          ...
          src={ favorited ? favortiteIcon : notFavoriteIcon }
          className="favoriteButton"
        >
          {favorited ? (
            <img src={ favortiteIcon } alt="Favorite" className="favoriteFill" />
          ) : (
            <img src={ notFavoriteIcon } alt="Favorite" className="favoriteNotFill" />
          )}
        </button>
      </div>
