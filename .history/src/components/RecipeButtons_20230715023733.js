...
function RecipeButtons({
  ...
  useEffect(() => {
    ...
    const progress = inProgressRecipes[recipeType] && inProgressRecipes[recipeType][recipeId];
    setIsRecipeInProgress(progress.sort((a, b) => a - b));
    const magicNumber = -1;
  ...
  }, [favorited, recipeId, setFavorited, setIsRecipeDone]);
